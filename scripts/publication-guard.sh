...
check_path() {
  ...
  base=${lower##*/}
  case "$lower" in
    agents/*|brain/*|factory/*|internal/*|private/*|prompts/*|policies/*|rules/*|skills/*|.startwave-agent/*|tools/atlas-agent/*|tools/startwave-agent/*|games/mir_kameadril/*|assets/data/bdo-*) block "$file" 'private, Factory, or owner-review path'; return 1 ;;
